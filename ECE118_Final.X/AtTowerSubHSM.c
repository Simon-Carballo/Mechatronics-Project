...
int first_corner = 0; //0 means first corner not traversed, 1 means first corner traversedd
/*******************************************************************************
 * PUBLIC FUNCTIONS                                                            *
 ******************************************************************************/
    ...
    switch (CurrentState) {
        ...
        case Align:
            ...
            switch (ThisEvent.EventType) {
                ...
                case ES_EXIT:
                    ES_Timer_InitTimer(LOST_SERVICE_TIMER, STOPTIME);
                    ThisEvent.EventType = ES_NO_EVENT;
                    break;
